...
namespace Nekoyume.Action.DPoS
{
    ...
    public sealed class MintAssetAction : IAction
    {
        private const string ActionTypeValue = "mint_asset_action";
        ...
        public MintAssetAction(Address address, FungibleAssetValue amount)
        {
            Address = address;
            Amount = amount;
        }

        public MintAssetAction()
        {
